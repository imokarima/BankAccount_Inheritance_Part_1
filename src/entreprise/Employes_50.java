...
public class Employes_50 extends Employe{
    private int nbHeure;
    private double chiffreAffaire;
    private double tarifHorraire=10;
    public Employes_50(String name) {
        super(name);
    }

    public Employes_50(String name,int nbHeure, double chiffreAffaire) {
        super(name);
        this.salaire=450;
    ...
    public double setInfoSalaire(){
        if(nbHeure>40){
            ...
            return this.salaire+=prixHSup*0.5;
        }
        return salaire;
    }
